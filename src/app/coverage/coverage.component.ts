...
export class CoverageComponent implements OnInit {
  ...
  product_id:any[]=[]
  view= false
  constructor(private router:Router, private fb:FormBuilder, private http:HttpClient, private countryservice: CountryService, private elementRef:ElementRef, private apiService:ApiService) { }
  ...
  ngOnInit(): void {
    ...
    this.apiService.getKMLfile().subscribe(res=>{
      let link = res['data'][0].media.pathUrls[0];

      this.kmlfileurl = link;
      console.log('KML', this.kmlfileurl);
