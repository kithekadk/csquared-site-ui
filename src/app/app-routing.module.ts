...
const routes: Routes = [
    ...
    {path: 'services/-', component: ProductsComponent},
    {path: 'services/infrastructure-solutions', component:ProductCategoryComponent},
    {path: 'services/digital-solutions', component:ProductCategoryComponent},
    {path:'services/infrastructure-solutions/view/:id', component: SingleServiceComponent},
    {path:'services/digital-solutions/view/:id', component: SingleServiceComponent},
    ...
    {path:'investors', component:PartnersComponent},
