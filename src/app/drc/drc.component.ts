...
export class DRCComponent implements OnInit {
  ...
  grids: {image:string, title:string, content:string}[]=[{image:"https://v1fiber.com/wp-content/uploads/2020/01/V1-Fiber-Aerial-Fiber.jpg", title:"Port fiber", content:"CSquared provides port fiber service targeted at SMEs. This service enables ISPs and MNOs to provide high-quality broadband at lower costs through shared infrastructure to any location. Port fiber is beneficial as it offers a reliable and resilient service, coupled with a variety of packages to suit businesses’ needs and a low latency solution built on end-to-end fiber infrastructure. "},{image:"https://www.atlantech.net/hubfs/Blog_images/Featured%20Images/ATL_Fiber-Optic-Install-Publishing%20%281%29.png", title:"Leased capacity", content:"CSquared offers high-capacity solutions geared towards enterprises, ISPs and MNOs. Leased capacity is advantageous as it provides full redundancy, high capacity ranging from speeds of 100 Mbps to 10 Gbps complete with an extensive network coverage."},{image:"https://www.aceee.org/sites/default/files/images/smart-manufacturing_web_size.jpg", title:"Dark fiber", content:"Dark fiber solution is an unrestricted connectivity solution designed to connect MNO Base Transceiver Stations (BTS) and Point to Point connections to large enterprises. As a business owner dark fiber provides you with complete control of your network as well as allowing a virtually unlimited capacity expansion. Dark fiber also accords you the highest level of security as dark fiber solutions are 100% dedicated for your use only."},{image:'https://www.atlantech.net/hubfs/Blog_images/Featured%20Images/ATL_Fiber-Optic-Install-Publishing%20%281%29.png', title:"Fiber To The Home", content:"CSquared offers wholesale FTTH services in Uganda. It has also expanded into the residential market, giving end users the freedom to choose a service provider of their choice using the same fiber connection. Users are also able to access large amounts of data at high speed."},{image:'https://www.atlantech.net/hubfs/Blog_images/Featured%20Images/ATL_Fiber-Optic-Install-Publishing%20%281%29.png', title:"Fiber To The Home", content:"CSquared offers wholesale FTTH services in Uganda. It has also expanded into the residential market, giving end users the freedom to choose a service provider of their choice using the same fiber connection. Users are also able to access large amounts of data at high speed."},{image:'https://www.atlantech.net/hubfs/Blog_images/Featured%20Images/ATL_Fiber-Optic-Install-Publishing%20%281%29.png', title:"Fiber To The Home", content:"CSquared offers wholesale FTTH services in Uganda. It has also expanded into the residential market, giving end users the freedom to choose a service provider of their choice using the same fiber connection. Users are also able to access large amounts of data at high speed."}];
